...
/**
 * Entidade EntradaMercadoriaItem.
 *
 * @author Carlos Eduardo Pauluk
 *
 */
@Entity
@Table(name = "est_entrada_mercadoria_item",
		uniqueConstraints = { @UniqueConstraint(columnNames = { "entrada_mercadoria_id", "produto_id" }) })
@EntityListeners({ UpperCaseListener.class, EntityIdListener.class })
@Cacheable
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@DynamicUpdate(true)
@DynamicInsert(true)
public class EntradaMercadoriaItem extends EntityIdImpl {
	...
	@JoinColumn(name = "entrada_mercadoria_id", nullable = false)
	@NotNull(message = "O campo 'entrada_mercadoria_id' deve ser informado")
	...
	public boolean equals(final Object obj) {
		...
		final EntradaMercadoriaItem iObj = (EntradaMercadoriaItem) obj;
		// Utiliza a API do apache-commons
		return new EqualsBuilder()
				.append(entradaMercadoria, iObj.entradaMercadoria)
